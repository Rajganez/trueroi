    ...
    >
      <div className="md:flex justify-center">
        <video
          ...
          className="mt-16"
        />
        <div className="md:text-4xl text-gray-700 text-2xl md:ml-20 ml-7 md:pt-10 pt-5">
          <span>Book for a Demo</span>
          <div className="md:mt-10 mt-3">
            <form>
              <div className="md:text-2xl text-xs p-1 m-1">
                <input
                  type="text"
              ...
              <div className="mt-2 ml-7 md:ml-20 md:mt-3">
                <button
                  className="border md:text-2xl text-xs rounded-full hover:bg-[white] 
